...
const placeDefinitions = [
  ...
  { id: 'praga', title: 'Ghetto di Praga', folder: 'ghetto-di-praga', eyebrow: 'Praga · 50.08° N, 14.44° E', x: 52.8, y: 54.0, description: 'Il quartiere ebraico di Praga, una presenza storica attraversata da secoli di memoria.' },
